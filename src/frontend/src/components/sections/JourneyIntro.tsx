      ...
      <div className="min-h-[270dvh]">
        <div className="sticky top-0 h-[100dvh] flex flex-col px-[var(--section-px)] pt-[calc(var(--ocean-nav-height)+1.25rem)]">
              ...
              {experienceReady && (
                <>
                  <motion.p
                    ...
                    className="journey-eyebrow !mb-0 !text-[var(--ocean-sunset-bright)]/80 [text-shadow:0_1px_16px_rgba(0,0,0,0.55)]"
                  >
                    {t.intro.greeting}
                  </motion.p>
                  ...
                  <motion.h1
                    ...
                    className="font-display font-extrabold text-[clamp(2.5rem,10vw,5.5rem)] leading-[0.95] tracking-tight text-[var(--ocean-text)] [text-shadow:0_2px_28px_rgba(0,0,0,0.6),0_0_80px_rgba(6,16,24,0.45)]"
                  >
                  ...
                  <motion.p
                    ...
                    className="text-[0.9375rem] sm:text-lg text-[var(--ocean-text-muted)] max-w-md mx-auto leading-relaxed px-2 [text-shadow:0_1px_20px_rgba(0,0,0,0.5)]"
                  >
                    {t.intro.tagline}
                  </motion.p>
                </>
          ...
          >
            ...
            <div className="w-px h-10 sm:h-12 bg-gradient-to-b from-[var(--ocean-sunset)]/60 to-transparent animate-pulse" />
          </motion.div>
        </div>
      </div>
    </JourneyStation>
