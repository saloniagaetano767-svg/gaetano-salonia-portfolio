...
import type { Profile as _Profile, Project as _Project, ProjectId as _ProjectId } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    constructor(private actor: ActorSubclass<_SERVICE>, private _uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, private _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, private processError?: (error: unknown) => never){}
    async addProject(arg0: string, arg1: string, arg2: Array<string>, arg3: string, arg4: string | null, arg5: string | null, arg6: string, arg7: boolean): Promise<ProjectId> {
    ...
    async updateProject(arg0: Project): Promise<boolean> {
        if (this.processError) {
            try {
