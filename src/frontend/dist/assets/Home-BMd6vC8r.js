...
import { S as Subscribable, s as shallowEqualObjects, h as hashKey, g as getDefaultState, n as notifyManager, u as useQueryClient, r as reactExports, a as noop$1, b as shouldThrowError, c as createLucideIcon, j as jsxRuntimeExports, d as useTranslation, C as CONTACT_EMAIL, G as GITHUB_URL, L as LINKEDIN_URL, e as usePrefersReducedMotion, f as useMouseParallax, i as scrollToSection, k as Skeleton, p as projectCode, l as Link } from "./index-q2gHaaMa.js";
import { u as useActor, c as createActor, a as useFeaturedProjects, S as SAMPLE_PROJECTS } from "./usePortfolio-CVpfKhzQ.js";
...
async function submitPortfolioContact(data, actor, fallback = submitPortfolioContactViaForm) {
  if (actor) {
    try {
...
function useContact() {
  ...
  return useMutation({
    mutationFn: (data) => submitPortfolioContact(data, actor)
  });
}
