...
import { S as Subscribable, s as shallowEqualObjects, h as hashKey, g as getDefaultState, n as notifyManager, u as useQueryClient, r as reactExports, a as noop$1, b as shouldThrowError, c as createLucideIcon, j as jsxRuntimeExports, d as useTranslation, C as CONTACT_EMAIL, G as GITHUB_URL, L as LINKEDIN_URL, e as usePrefersReducedMotion, f as useMouseParallax, i as scrollToSection, k as Skeleton, p as projectCode, l as Link } from "./index-o7ZE6tk5.js";
import { u as useActor, c as createActor, a as useFeaturedProjects, S as SAMPLE_PROJECTS } from "./usePortfolio-B8XKDDNW.js";
...
function isHTMLElement(element) {
  return isObject$2(element) && "offsetHeight" in element && !("ownerSVGElement" in element);
}
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-mono text-[11px] text-primary tracking-[0.14em] uppercase mb-3.5", children: [
                "01 / ",
                t.about.label
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display font-extrabold text-[clamp(34px,5vw,52px)] tracking-tight leading-tight mb-10", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "grad-light", children: t.about.titleLight }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "grad-teal", children: t.about.titleAccent })
              ] })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-[1fr_260px] gap-12 lg:gap-16 items-start", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.aside,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(InfoRow, { label: "Location", value: t.about.location }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(InfoRow, { label: "Company", value: t.about.company }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(InfoRow, { label: "Status", value: t.about.status }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(InfoRow, { label: "Languages", value: t.about.languages }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(InfoRow, { label: "Apprenticeship", value: t.about.apprenticeship })
              ]
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            className: "mt-20",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-mono text-[11px] text-primary tracking-[0.14em] uppercase mb-8", children: [
                "04 / ",
...
async function submitPortfolioContactViaForm(data) {
  ...
  const deliveryFailed = (responseBody == null ? void 0 : responseBody.success) === false || (responseBody == null ? void 0 : responseBody.success) === "false";
  if (!response.ok || deliveryFailed) {
    throw new Error(
      (responseBody == null ? void 0 : responseBody.message) || bodyText.trim() || "Could not send — please email me directly using the address on this page."
    );
  }
}
function parseFormSubmitResponse(bodyText) {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display font-extrabold text-[clamp(34px,5vw,52px)] tracking-tight leading-tight mb-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "grad-light", children: t.contact.titleLight }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-12 items-start", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.div,
            {
              ...
              children: contactItems.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                ...
                {
                  href: item.href,
                  target: item.label === "Email" ? void 0 : "_blank",
                  rel: item.label === "Email" ? void 0 : "noopener noreferrer",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.div,
            {
              ...
              viewport: { once: true },
              transition: { duration: 0.7, delay: 0.1 },
              children: isSuccess ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
...
function AvatarPortrait() {
  ...
  const [src, setSrc] = reactExports.useState(AVATAR_SRC);
...
function HeroSection() {
  ...
  const [roleVisible, setRoleVisible] = reactExports.useState(true);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 w-full max-w-[1100px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-1.5 h-1.5 rounded-full bg-primary badge-dot shadow-[0_0_8px] shadow-primary" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-mono text-[11px] text-primary font-semibold tracking-wider", children: [
                  t.about.status,
                  " · RUAG · 🇨🇭"
                ] })
              ]
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.h1,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "grad-light block", children: "Gaetano" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "grad-teal block", children: "Salonia." })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-8 overflow-hidden mb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "p",
            {
              className: `font-mono text-base text-primary font-semibold transition-all duration-350 ${roleVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-2"}`,
              children: [
                "// ",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          motion.div,
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(AvatarPortrait, {})
          }
        )
      ] })
    }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display font-extrabold text-[clamp(34px,5vw,52px)] tracking-tight leading-tight mb-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "grad-light", children: t.services.titleLight }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-5", children: t.services.categories.map((cat, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.article,
          {
            initial: { opacity: 0, y: 28 },
            whileInView: { opacity: 1, y: 0 },
...
function WorkSlide({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-w-0 flex-[0_0_100%] px-1", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    Link,
    {
      to: "/projects/$id",
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-2 text-sm font-semibold text-primary group-hover:gap-3 transition-all", children: [
          t.work.viewProject,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display font-extrabold text-[clamp(34px,5vw,52px)] tracking-tight leading-tight mb-10", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "grad-light", children: t.work.titleLight }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "grad-teal", children: t.work.titleAccent })
              ] })
            ]
          }
        ),
        isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-80 w-full rounded-[18px] bg-muted" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(
          motion.div,
          {
            initial: { opacity: 0, y: 36 },
            whileInView: { opacity: 1, y: 0 },
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-hidden", ref: emblaRef, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex", children: projects.map((project, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                WorkSlide,
                {
                  project,
                  index: i,
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mt-6", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-1.5", children: projects.map((p, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    type: "button",
...
function Home() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-[1]", "data-ocid": "home.page", children: [
